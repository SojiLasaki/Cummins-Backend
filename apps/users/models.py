...
class User(AbstractUser):
    ...
    class Roles(models.TextChoices):
        ...
        ENGINE_TECH = "engine_tech", "Engine Technician"
        ELECTRICAL_TECH = "electrical_tech", "Electrical Technician"
    ...
    @property
    def is_engine_tech(self):
        return self.role == self.Roles.ENGINE_TECH

    @property
    def is_electrical_tech(self):
        return self.role == self.Roles.ELECTRICAL_TECH
